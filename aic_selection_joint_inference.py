...
#wanted_wells = [352, 353, 354] # Used for 10-3-17
#wanted_wells = [13,61,72,20] # for 10-3-17
wanted_wells = [253,254,255,256] # for 10-3-17
#wanted_wells = [40, 41,42] # for 2-3-17
...
lines = lines[2:]
output_file = open("joint_fluorescence_reads.dat", 'w')
